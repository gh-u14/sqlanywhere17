...
# $2 backup directory
{
    ...
    if [ "`plat_os`" = "macos" ] && [ -d "$INST_DIR/System/bin32" ] ; then
        if [ ${BACK_DIR} = "null" ] ; then
            rm -rf $INST_DIR/System/bin32
            rm -rf $INST_DIR/System/bin32s
            rm -rf $INST_DIR/System/lib32
        else
            mkdir -p $BACK_DIR/System/bin32
            mv $INST_DIR/System/bin32/* $BACK_DIR/System/bin32
            mv $INST_DIR/System/bin32s/* $BACK_DIR/System/bin32s
            mv $INST_DIR/System/lib32/* $BACK_DIR/System/lib32
        fi
    fi
}
...
# $2 backup directory
{
    ...
    if [ "`plat_os`" = "macos" ] && [ -d "$BACK_DIR/System/bin32" ] ; then
        rm -rf $INST_DIR/System/bin32/*
        rm -rf $INST_DIR/System/bin32s/*
        rm -rf $INST_DIR/System/lib32/*
        mv $BACK_DIR/System/bin32/* $INST_DIR/System/bin32/
        mv $BACK_DIR/System/bin32s/* $INST_DIR/System/bin32s/
        mv $BACK_DIR/System/lib32/* $INST_DIR/System/lib32/
    fi
}
